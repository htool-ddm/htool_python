...
target_cluster: Htool.Cluster = cluster_builder.create_cluster_tree(
    points, number_of_children, size_of_partition=mpi4py.MPI.COMM_WORLD.size
)
...
hmatrix_tree_builder = Htool.HMatrixTreeBuilder(epsilon, eta, "N", "N")

hmatrix_tree_builder.set_dense_blocks_generator(custom_dense_blocks_generator)
