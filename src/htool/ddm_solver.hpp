...
void declare_DDM(py::module &m, const std::string& className) {
    ...
    py::class_<Class>(m, className.c_str())
        ...
        .def("solve",[](Class &self, py::array_t<T,  py::array::f_style> x,const py::array_t<T,  py::array::f_style | py::array::forcecast> b, std::string hpddm_args){
